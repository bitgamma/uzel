...
exports.Device.prototype.getFullID = function() {
  return this.subdeviceID ? (this.getPhysicalID() + "#" + this.subdeviceID) : this.getPhysicalID();
}
...
exports.DeviceManager.prototype.getDevicesByFullID = function(fullID) {  
  return findDevicesByFullID(this._pairedDevices);
}
...
function handleDiscoveredDevice(connectorName, cb, deviceID, deviceProtocolInfo) {
  var newDevice = new Device(deviceID, connectorName, deviceProtocolInfo);
  var newFullID = newDevice.getFullID();
  
  if (this.getDevicesByFullID(newFullID) || findDevicesByFullID(this._unpairedDevices, newFullID)) {
    return;
  }
...
function findDevicesByFullID(array, fullID) {
