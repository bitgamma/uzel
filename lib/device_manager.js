...
exports.Device = function(connector, protocolInfo, parentDevice, subdeviceID) {
  this.connector = connector;
  this.protocolInfo = protocolInfo;
  this.physicalID = this.connector + "|" + this.protocolInfo.id;
  this.id = this.parent ? (this.physicalID + "#" + this.subdeviceID) : this.physicalID;
...
function handleDiscoveredDevice(connectorName, deviceProtocolInfo) {
  ...
  if (this.getDeviceByID(newID) || findDeviceByID(this._unpairedDevices, newID)) {
    return;
  }
