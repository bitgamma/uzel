...
function handlePairedDevice(cb, device, err) {
  handlePairingResponse('devicePaired', this._unpairedDevices, this._pairedDevices, cb, device, err)
}

function handleUnpairedDevice(cb, device, err) {
  handlePairingResponse('deviceUnpaired', this._pairedDevices, this._unpairedDevices, cb, device, err)
}
