...
exports.DeviceManager = function(config) {
  ...
  this._config = config;
  this._pairedDevices = [];
  this._deviceDatastore = new Datastore({ filename: path.join(config.persistencyPath, 'devices.nedb') });
...
exports.DeviceManager.prototype.start = function(done) {  
  this._deviceDatastore.loadDatabase(function() {
...
exports.DeviceManager.prototype.getDeviceByID = function(id, cb) {  
  cb(findDeviceByID(this._pairedDevices, id));
}

exports.DeviceManager.prototype.getUnpairedDeviceByID = function(id, cb) {  
  cb(findDeviceByID(this._unpairedDevices, id));
}
...
exports.DeviceManager.prototype.sendCommands = function(commands) {
  ...
  for (var physicalDeviceID in groupedCommands) {
    this.sendPacket(groupedCommands[physicalDeviceID][0], groupedCommands[physicalDeviceID]);
  }
}
